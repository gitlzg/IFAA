...
##'                 bootB = 5)
##'
##' @references Li et al.(2020) IFAA: Robust association identification and Inference For Absolute Abundance in microbiome analyses. \url{https://arxiv.org/pdf/1909.10101.pdf}
